import{B as P,al as D,o as _,c as E,a as rn,m as x,R as ln,k as j,d as dn,t as an,aE as K,M as sn,aF as bn,aG as V,aH as L,aI as C,aJ as pn,aK as gn,aL as vn,O as fn,aM as W,az as mn,r as M,aN as G,aO as J,av as hn,aP as yn,aQ as kn,e as wn,g as $n,j as q,G as xn,J as Sn,p as N,w as Pn,n as Q,I as X,q as _n}from"./BM9grzN6.js";import{s as F,B as U,u as Cn}from"./DdRiL9NS.js";var On=`
.p-icon {
...
`)},Dn={root:function(t){var n=t.props,e=t.instance;return["p-badge p-component",{"p-badge-circle":ln(n.value)&&String(n.value).length===1,"p-badge-dot":D(n.value)&&!e.$slots.default,"p-badge-sm":n.size==="small","p-badge-lg":n.size==="large","p-badge-xl":n.size==="xlarge","p-badge-info":n.severity==="info","p-badge-success":n.severity==="success","p-badge-warn":n.severity==="warn","p-badge-danger":n.severity==="danger","p-badge-secondary":n.severity==="secondary","p-badge-contrast":n.severity==="contrast"}]}},Vn=P.extend({name:"badge",theme:En,classes:Dn}),Ln={name:"BaseBadge",extends:F,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Vn,provide:function(){return{$pcBadge:this,$parentInstance:this}}},un={name:"Badge",extends:Ln,inheritAttrs:!1};function Mn(o,t,n,e,r,u){return _(),E("span",x({class:o.cx("root")},o.ptmi("root")),[j(o.$slots,"default",{},function(){return[dn(an(o.value),1)]})],16)}un.render=Mn;function B(o){"@babel/helpers - typeof";return B=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},B(o)}function nn(o,t){return Hn(o)||Rn(o,t)||Un(o,t)||Nn()}function Nn(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
