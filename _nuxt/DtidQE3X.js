...
`)},yn={root:function(t){var e=t.instance,r=t.props;return["p-inputtext p-component",{"p-filled":e.$filled,"p-inputtext-sm p-inputfield-sm":r.size==="small","p-inputtext-lg p-inputfield-lg":r.size==="large","p-invalid":e.$invalid,"p-variant-filled":e.$variant==="filled","p-inputtext-fluid":e.$fluid}]}},wn=te.extend({name:"inputtext",theme:hn,classes:yn}),$n={name:"BaseInputText",extends:bn,style:wn,provide:function(){return{$pcInputText:this,$parentInstance:this}}},kn={name:"InputText",extends:$n,inheritAttrs:!1,methods:{onInput:function(t){this.writeValue(t.target.value,t)}},computed:{attrs:function(){return E(this.ptmi("root",{context:{filled:this.$filled,disabled:this.disabled}}),this.formField)}}},On=["value","disabled","aria-invalid"];function xn(n,t,e,r,f,v){return M(),W("input",E({type:"text",class:n.cx("root"),value:n.d_value,disabled:n.disabled,"aria-invalid":n.$invalid||void 0,onInput:t[0]||(t[0]=function(){return v.onInput&&v.onInput.apply(v,arguments)})},v.attrs),null,16,On)}kn.render=xn;export{pn as a,rn as b,kn as s};
